      ...
      <div className="p-2">
        <div className="relative">
          ...
          <input
            ...
            className={`w-full p-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
              theme === "dark"
                ? "bg-gray-800 text-white border-gray-700 placeholder-gray-500"
                : "bg-gray-200 text-black border-gray-200 placeholder-gray-400"
            }`}
            value={searchTerms}
